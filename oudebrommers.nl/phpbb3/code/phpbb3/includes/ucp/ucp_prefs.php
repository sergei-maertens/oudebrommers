...
class ucp_prefs
{
	...
	function main($id, $mode)
	{
		...
		{
			case 'personal':
				$user->add_lang('mods/user_mention');
				...
				$data = array(
					...
					'notifymention'		=> request_var('notifymention', (bool) $user->data['user_notify_mention']),
				...
				if ($submit)
				{
					...
					if (!sizeof($error))
					{
						...
						$sql_ary = array(
							...
							'user_notify_mention'		=> $data['notifymention'],
				...
				$template->assign_vars(array(
					...
					'S_NOTIFY_MENTION'		=> $data['notifymention'],
