...
* @version $Id: watermark_afterward_2_png.php  2010-05-22 13:29:12Z 4seven $
...
if ($config['watermark_type'] == 'text'){
 ...
 if ($handle = opendir($original_directory))
 {
    while (false !== ($file = readdir($handle)))
    {
      ...
      if (exif_imagetype($original_directory.$file)== 3){
...
<hr />
' . utf8_decode($user->lang['STEP_2_PNG_FINISH']) . '
<hr />
' . utf8_decode($user->lang['STEP_3_COPY_START'])  . '
<hr />
</body>
</html>';
