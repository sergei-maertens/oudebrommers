...
class phpbb_mobile
{
	...
	*/
	protected static function create_link($template, $mode, $lang)
	{
		...
		{
			case 'switch_full':
				$text = isset($user->lang[$lang_key]) ? $user->lang[$lang_key] : 'Wijzig naar volledige versie';
				break;

			case 'switch_mobile':
				$text = isset($user->lang[$lang_key]) ? $user->lang[$lang_key] : 'Wijzig naar mobiele versie';
				break;
