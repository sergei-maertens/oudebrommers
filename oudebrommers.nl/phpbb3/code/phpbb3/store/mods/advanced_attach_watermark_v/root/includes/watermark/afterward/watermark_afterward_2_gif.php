...
* @version $Id: watermark_afterward_2_gif.php  2010-05-22 13:29:12Z 4seven $
...
if ($config['watermark_type'] == 'text'){
 ...
 if ($handle = opendir($original_directory))
 {
    while (false !== ($file = readdir($handle)))
    {
      ...
      if (exif_imagetype($original_directory.$file)== 1){
...
<hr />
' . utf8_decode($user->lang['STEP_2_GIF_FINISH']) . '
<hr />
' . utf8_decode($user->lang['STEP_2_PNG_START'])  . '
<hr />
</body>
</html>';
